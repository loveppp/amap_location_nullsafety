import 'dart:async';
import 'dart:io';
import 'package:amap_location_flutter_plugin_example/LocationManager.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  late AmapLocationFlutterPlugin _locationPlugin;
    ...
    return new Container(
        ...
        child: new Row(
          ...
          children: <Widget>[
            new RaisedButton(
              onPressed: () {
                LocationManager().startLocation((address) {
                  print(address ?? '' + "           世纪地址");
                });
              },
              child: new Text('开始定位'),
